...
namespace XiaolzCSharp
{
	public class API
	{
		...
		[UnmanagedFunctionPointer(CallingConvention.StdCall)]
		[return: MarshalAs(UnmanagedType.LPStr)]
		public delegate string SendPrivateMsgDelegate(string pkey, long ThisQQ, long SenderQQ, [MarshalAs(UnmanagedType.LPStr)] string MessageContent, ref long MessageRandom, ref uint MessageReq);

		public static SendGroupMsgDelegate SendGroupMsg = null;
		[UnmanagedFunctionPointer(CallingConvention.StdCall)]
		[return: MarshalAs(UnmanagedType.LPStr)]
		public delegate string SendGroupMsgDelegate(string pkey, long thisQQ, long groupQQ, [MarshalAs(UnmanagedType.LPStr)] string msgcontent, bool anonymous);
		...
		[UnmanagedFunctionPointer(CallingConvention.StdCall)]
		[return: MarshalAs(UnmanagedType.LPStr)]
		public delegate string GetAdministratorListDelegate(string pkey, long thisQQ, long gruopQQ);
		...
		//[UnmanagedFunctionPointer(CallingConvention.StdCall)]
		//[return: MarshalAs(UnmanagedType.LPStr)]
		//public delegate string GetLoginQQDelegate(string pkey);
		...
		[UnmanagedFunctionPointer(CallingConvention.Winapi, CharSet = CharSet.Ansi)]
		[return: MarshalAs(UnmanagedType.LPStr)]
		public delegate string GetImageDownloadLinkDelegate(string pkey, string guid, long thisQQ, long groupQQ);
		...
		[UnmanagedFunctionPointer(CallingConvention.StdCall)]
		[return: MarshalAs(UnmanagedType.LPStr)]
		public delegate string UploadFriendImageDelegate(string pkey, long thisQQ, long friendQQ, bool is_flash, [MarshalAs(UnmanagedType.LPArray)] byte[] pic, int picsize);

		public static UploadGroupImageDelegate UploadGroupImage = null;
		[UnmanagedFunctionPointer(CallingConvention.StdCall)]
		[return: MarshalAs(UnmanagedType.LPStr)]
		public delegate string UploadGroupImageDelegate(string pkey, long thisQQ, long friendQQ, bool is_flash, [MarshalAs(UnmanagedType.LPArray)] byte[] pic, int picsize);
		...
		[UnmanagedFunctionPointer(CallingConvention.StdCall)]
		[return: MarshalAs(UnmanagedType.LPStr)]
		public delegate string UploadFriendAudioDelegate(string pkey, long thisQQ, long friendQQ, int audio_type, [MarshalAs(UnmanagedType.LPStr)] string audio_text, [MarshalAs(UnmanagedType.LPArray)] byte[] audio, int audiosize);

		public static UploadGroupAudioDelegate UploadGroupAudio = null;
		[UnmanagedFunctionPointer(CallingConvention.StdCall)]
		[return: MarshalAs(UnmanagedType.LPStr)]
		public delegate string UploadGroupAudioDelegate(string pkey, long thisQQ, long friendQQ, int audio_type, [MarshalAs(UnmanagedType.LPStr)] string audio_text, [MarshalAs(UnmanagedType.LPArray)] byte[] audio, int audiosize);

		public static SaveFileToWeiYunDelegate SaveFileToWeiYun = null;
		[UnmanagedFunctionPointer(CallingConvention.Winapi, CharSet = CharSet.Ansi)]
		[return: MarshalAs(UnmanagedType.LPStr)]
		public delegate string SaveFileToWeiYunDelegate(string pkey, long thisQQ, long groupQQ, [MarshalAs(UnmanagedType.LPStr)] string file_id);
		...
		public string SendFriendImage(long thisQQ, long friendQQ, string picpath, bool is_flash)
		{
			...
			string piccode = UploadFriendImage(plugin_key, thisQQ, friendQQ, is_flash, picture, picture.Length);
			long MessageRandom = 0;
			uint MessageReq = 0;
			return SendPrivateMsg(plugin_key,thisQQ, friendQQ,piccode,ref MessageRandom, ref MessageReq);
		}	
		...
		public string SendGroupImage(long thisQQ, long groupQQ, string picpath, bool is_flash)
		{
			Bitmap bitmap = new Bitmap(picpath);
			byte[] picture = GetByteArrayByImage(bitmap);
			string piccode = UploadGroupImage(plugin_key, thisQQ, groupQQ, is_flash, picture, picture.Length);
		...
		{		
			var ret = GetAdministratorList(plugin_key, thisQQ, gruopNumber);
