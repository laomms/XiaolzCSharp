...
namespace XiaolzCSharp
{
    class PInvoke
    {
		...
		{
			Friend_Removed = 15, // 好友事件_被好友删除
			Friend_SignatureChanged = 16, // 好友事件_签名变更
			Friend_NameChanged = 17, // 好友事件_昵称改变
			Friend_UserUndid = 18, // 好友事件_某人撤回事件
			Friend_NewFriend = 19, // 好友事件_有新好友
			Friend_FriendRequest = 20, // 好友事件_好友请求
			Friend_FriendRequestAccepted = 21, // 好友事件_对方同意了您的好友请求
			Friend_FriendRequestRefused = 22, // 好友事件_对方拒绝了您的好友请求
			Friend_InformationLiked = 23, // 好友事件_资料卡点赞
			Friend_SignatureLiked = 24, // 好友事件_签名点赞
			Friend_SignatureReplied = 25, // 好友事件_签名回复
